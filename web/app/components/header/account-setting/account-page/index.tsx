      ...
      {showDeleteAccountModal && (
        ...
        >
          ...
          <div className='mt-3 text-sm leading-5'>
            ...
            <a className='text-primary-600 cursor' href={`mailto:support@dify.ai?subject=Delete Account Request&body=Delete Account: ${userProfile.email}`} target='_blank'>support@pdmi.cn</a>
          </div>
